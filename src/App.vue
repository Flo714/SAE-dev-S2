...
<template>
  <header>
    <div class="flex justify-between p-1 bg-Dark-marron">
      ...
      <div id="menu" class="fixed inset-0 z-20 translate-x-full lg:hidden bg-marron bg-Dark-marron motion-safe:duration-1000 motion-safe:transition-transform" 
  ...
  <footer class="bg-Dark-marron p-6">
...
<script>
import Menu from "../src/components/icons/MenuView.vue"

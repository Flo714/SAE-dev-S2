<template>
    ...
    <section class="my-8">
        ...
        <ul class="list-none">
            ...
            <li>14H00 - Concert du groupe : L'Otite Orphéonique</li>
            <li>17H00 - Concert de Louise Jallu</li>
            <li>20H00 - Pause dîner</li>
    ...
    <section class="mt-8 pb-8">
        ...
        <ul>
            ...
            <li>13H00 - Pause déjeuner</li>
            <li>14H00 - Concert de Louise Jallu</li>
            <li>17H00 - Concert du groupe : L'Otite Orphéonique</li>
            <li>20H00 - Pause dîner</li>
